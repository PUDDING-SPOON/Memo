...
public class Tools {
    ...
    public static void createTable(SQLiteDatabase sql){
        try{
            Cursor c = sql.rawQuery("select * from  files ", null);
            c.moveToNext();
        }
        ...
        try{
            ...
            sql.execSQL("create table user(datetime varchar(30),content varchar(1000),alerttime varchar(30),fileIndex varchar(30))");
        }
    }
    ...
    public static String toDateString(Calendar calendar){
        ...
        return calendar.get(Calendar.YEAR)+"年"
                +Tools.format(calendar.get(Calendar.MONTH)+1)+"月"
